...
#
# 前置条件：
#   - codegen_runner_deploy/payload/ 完整（含 sdk/、runner.py、eye_matrix_8x8.py）
...
PAYLOAD="$REPO_DIR/codegen_runner_deploy/payload"
...
echo ""
echo " 下一步："
echo "   验证 4 个部件: PI_USER=$PI_USER ./scripts/codegen_runner/verify_pi_setup.sh $PI_IP"
